    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.btnActions}>
                ...
                <button className={styles.favorite} disabled={!user} style={{ pointerEvents: !user ? 'none' : 'auto' }} onClick={() => toggleFavorite(character.id)}>
                    <svg className={styles.heart} style={{ fill: isFavorite(character.id) ? 'red' : 'white' }} width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
